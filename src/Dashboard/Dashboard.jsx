...
class Dashboard extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      courses: [
        { id: 1, title: 'Web Design: Form Figma to wa', icon: '⚒️', lesson: 15, assignment: 12, test: 10 },
    ...
    return (
      <div className="circular-progress">
        <svg width="80" height="80" viewBox="0 0 90 90">
          ...
          />
          <text x="45" y="50" textAnchor="middle" fontSize="14" fontWeight="bold" fill="#333">
            {percentage}%
          </text>
        </svg>
      </div>
      ...
      <div className="dashboard">
        <div className="dashboard-grid">
          ...
          <div className="dashboard-left">
            ...
            {/* My Courses Section - Now placed where Calendar was previously */}
          ...
          <div className="dashboard-right">
            {/* Calendar Section - Now smaller and above Upcoming */}
            <div className="calendar-section">
              <div className="calendar-header">
                <h3>Calendar</h3>
                <div className="month-navigation">
                  <button className="nav-button" onClick={this.goToPreviousMonth}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <button className="nav-button" onClick={this.goToNextMonth}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
